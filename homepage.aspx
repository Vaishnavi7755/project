    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <center>
                    <h2 style="margin-top:25px;">Our features</h2>
                    <p style="margin-bottom:25px;"><b>Our 3 primary features</b></p>
                    </center>
                </div>
            </div>
             <div class="row">
                <div class="col-md-4">
                    <center>
                    <img src="Stock/digidata.png" width="150px" style="margin-top:20px; "/>
     ...
     <section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <center>
                    <h2 style="margin-top:25px;">More</h2>
                    <p style="margin-bottom:25px;"><b>For more information about us.</b></p>
                    </center>
                </div>
            </div>
             <div class="row">
